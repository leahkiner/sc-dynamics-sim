...
def run(show_plots):
    ...
    array1MaxTransAccelList = [transAccelMax,
                               0.0,
                               0.0,
                               0.0,
                               0.0]
    ...
    for i in range(numArrayElements):
        ...
        if (i == 0):
            ...
            array1ElementMessageData.scalarPos = 0.0  # [m]
    ...
    array2MaxTransAccelList = [transAccelMax,
                               0.0,
                               0.0,
                               0.0,
                               0.0]
    ...
    for i in range(numArrayElements):
        ...
        if (i == 0):
            ...
            array2ElementMessageData.scalarPos = 0.0  # [m]
    ...
    for i in range(numArrayElements):
        ...
        if (i == 0):
            ...
            array2ElementMessageData.scalarPos = - 1 * lenPanel  # [m]
        else:
            array2ElementMessageData.scalarPos = 0.0  # [m]
    ...
    omega_BN_B_teles_rigid_data_file = open(r"/Users/leahkiner/Desktop/GNCBreck2024/DataForPlotting/omega_BN_B_teles_rigid_data.txt", "w+")
